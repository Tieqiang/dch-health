...
public class TemplatePageConfigService {
     ...
     */
    @GET
    @Path("get-page-data-elements-by-templateId")
    public DataElementVO getDataElementVOByTemplateId(@QueryParam("templateId")String templateId){
        return templatePageConfigFacade.getDataElementVOByTemplateId(templateId);
    }
