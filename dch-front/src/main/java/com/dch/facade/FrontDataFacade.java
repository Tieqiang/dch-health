...
public class FrontDataFacade extends BaseFacade {
    ...
    public FrontSearchCategory getDataDetail(String id) throws Exception {
        ...
        List<FrontSearchCategory> frontSearchCategoryList = createQuery(FrontSearchCategory.class, hql, new ArrayList<Object>()).getResultList();
    ...
    public List<FrontSearchCategoryField> getDataFields(String categoryId) {
        ...
        return createQuery(FrontSearchCategoryField.class, hql, new ArrayList<Object>()).getResultList();
